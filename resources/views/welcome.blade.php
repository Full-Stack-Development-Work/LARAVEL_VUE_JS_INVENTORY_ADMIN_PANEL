...
<head>
    ...
    <!--this is for 'error free console'/(vue_devTool)-->
    <title>Admin Inventory </title>

    <link rel="stylesheet" href="{{ asset('css/app.css') }}">
    <!--must be linked at the Top of All other CSS_files-->
...
<body class="sb-nav-fixed">
    ...
    <div id="app">
        <!---VUE_JS er jonno ei id='app' div ta niyechi pora/entire body tar jonno--->
    ...
    <!---End___VUE_JS er jonno j id='app' div ta niyechilam pora body tar jonno--->
    ...
    <!--must be linked at the Top of All other JS_files-->
